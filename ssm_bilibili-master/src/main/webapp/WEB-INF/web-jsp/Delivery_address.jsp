	...
	<div class="centers_m">
		...
		<div class="public_m1">
			...
			<div class="public_m4">
				...
				<p>
					<em>用户真实名字：</em> <input type="text" name="usermingzi" style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</p>

				<p>
					<em>手机号：</em> <input type="text" name="userPhone" style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</p>
				
				<p>
					<em>收货地址：</em> <input type="text" name = "userAddress" style="height: 23px; border: 1px solid #eaeaea; width: 530px">
				</p>
				<p>
					<span style="color: red"><%=request.getAttribute("tishi") %></span>
				</p>
