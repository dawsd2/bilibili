...
<%-- 				<div class="centers_listm_one_in">
		...
		<div class="public_m1">
			...
			<form action="Update_Phone.sf" method="post">
				<div class="public_m4">
					<p>
						<em>原绑定手机号：</em> <input type="text" name="userPhone" style="height: 23px; border: 1px solid #eaeaea; width: 140px"/>
					</p>

					<p>
						<em>新手机号码：</em> <input type="text" name="newuserPhone" style="height: 23px; border: 1px solid #eaeaea; width: 140px"/>
						<input type="button" id="btnsj" class="btn_mfyzm" value="获取验证码" style="border: 1px solid #c8c8c8; margin-left: 6px"/>
					</p>
					<p>
						<em>收到的验证码：</em> <input type="text" style="height: 23px; border: 1px solid #eaeaea; width: 140px"/>
					</p>
