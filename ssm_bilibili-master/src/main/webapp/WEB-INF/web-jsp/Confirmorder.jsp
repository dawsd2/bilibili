...
<div style="width: 1000px;height: 500px;background-color: white;position: fixed; z-index: 999;margin-left:12%;display: none"
    ...
    <div align="center" id="pwd">请输入支付密码:<input type="password" id="oText">
        <input type="button" id="zhifu" value="支付" style="margin-left:20px"></div>
    <div align="center">
        <br>
...
<div id="page">
 ...
 <a href="Delivery_address.sf" target="_blank" title="管理我的收货地址" class="J_MakePoint"
    data-point-url="Delivery_address.sf">修改收货地址</a>
 </span>
                </h3>
                <ul id="address-list" class="address-list">
                    <li class="J_Addr J_MakePoint clearfix  J_DefaultAddr "
                        data-point-url="http://log.mmstat.com/buy.1.20">
                        <del class="J_Marker marker"></del>
                                        ...
                                        <li>
                                            <div class="field gbook">
                                                ...
                                                <textarea style="width:350px;height:80px;"
                                                          title="选填：对本次交易的补充说明（建议填写已经和卖家达成一致的说明）" name="">
...
<!--  <em class="style-normal-bold-red J_FareSum"  >30.00</em> -->
 ...
 <span>&yen;</span><em class="style-large-bold-red" id="J_ActualFee"></em>
                ...
                <a href="gouwuche.sf" class="back J_MakePoint" target="_top" data-point-url="">返回购物车</a>
