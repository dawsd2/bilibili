...
<script type="text/javascript" language='javascript' src="<%=request.getContextPath()%>/static/register/js/jq22.js"></script>
</head>
...
<form id="form" action="register.sf" method="post" onSubmit="return check();">
<div id="form_submit" class="form_submit">
<div class="fieldset">

<div class="field-group">
<label class="required title">手机号码</label> <span class="control-group" id="mobile_input">
<div class="input_add_long_background">
	<input class="register_input" type="text" id="mobile" name="userPhone" maxLength="11" onblur="__changeUserName('mobile');">
</div>
</span> <label class="tips">仅用于发送服务开通与到期提醒以及紧急故障方便联系到您，绝对保密</label>
</div>
	<div class="field-group">
		<label class="required title">QQ号码</label>
		<span class="control-group" id="qq_input">
<div class="input_add_long_background">
		<input class="register_input" type="text" id="userQQ" name="userQQ" maxLength="10" onblur="">
</div>
</span>
	</div>
	<div class="field-group">
...
<div class="input_add_long_background">
	<input class="register_input" type="text" id="email" name="userEmial" maxLength="50" onblur="__changeUserName('email');">
</div>
...
class="control-group">
<div class="input_add_long_background">
	<input class="register_input" type="text" id="username" name="userName" maxLength="50" onblur="">
</div>
...
<div class="input_add_long_background">
	<input class="register_input" type="passWord" id="password1" name="passWord" maxLength="20" onblur="checkPwd1(this.value);" />
</div>
</span> <label class="tips">请使用6~20个英文字母（区分大小写）、符号或数字</label>
</div>
<div class="field-group">
<label class="required title" >验证码</label> <span class="control-group" id="code_input" >
<div class="input_add_background" style="margin-right: 15px;">
	<input class="register_input_ot" type="text" id="code" name="yanzheng" max_length="6" onblur="checkAuthCode(this.value);">
</div>
