...
public class LoginRequest {
    ...
    public @ResponseBody void yanzhengpass(HttpServletRequest request, HttpServletResponse response, String pass, String zong, String shangpingmingzi, String shangpingtupiao, String dizhi) throws IOException {
        ...
        if (bl) {
            ...
            shangpingjiage = Integer.parseInt(zong);//商品价格
            int sqljiage = 0;
            sqljiage = Integer.parseInt(RMB);//用户的钱
    ...
    public String Delivergoods(HttpServletRequest request, String orderID) {
        ...
        if (bl) {
            System.out.println("立即发货成功");
        } else {
            System.out.println("立即发货失败");
        }
    ...
    public String Returngoods(HttpServletRequest request, String orderID) {
        ...
        if (bl) {
            System.out.println("立即退货成功");
        } else {
            System.out.println("立即退货失败");
        }
