...
<link rel="stylesheet" href="<%=request.getContextPath()%>/static/Houtai/css/style.css" type="text/css" />
	<script src="<%=request.getContextPath()%>/static/Homepage/js/sHover.min.js"></script>
	<script src="<%=request.getContextPath()%>/static/User_Data_Update/js/jquery-1.8.3.min.js"></script>
		<!-- 这里还是用ajax提交 -->
		 <!-- 这里是自定义的js -->
<script src="<%=request.getContextPath()%>/static/adminjs/chaxunjs.js"></script>
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD width="160" align="center">
			  <ul>
				  <li><a href="userID.sf?userID=${list.userID}">查看</a></li>
			  </ul>
		  </TD>
        </TR>
			</c:forEach>
