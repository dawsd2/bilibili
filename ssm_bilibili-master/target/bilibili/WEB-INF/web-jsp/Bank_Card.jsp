...
<body>
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			<!--结束-->
			<div class="dao_list">
				<a href="logoone.sf">首页</a>
				<a href="javascript:return false;">视频收藏</a>
				<a href="Shopping.sf">周边</a>
...
window.onload=function(){
	...
	<div class="now_positionm">
		<span>当前位置：</span><a href="logoone.sf">首页></a>
	...
	<div class="centers_m">
		...
		<div class="centers_ml">
			...
			<div class="center_header">
				<a href="User_full_information.sf">
					<img src="<%=request.getContextPath()%><%=request.getSession().getAttribute("userHand")%>" /></a>
				<em>您好，<span><%=request.getSession().getAttribute("userName")%></span></em>
				<span style="color: red; font-size: 11px;">(下方可修改资料~喵)</span>
			</div>
			<!--列表go-->
			<div class="centers_listm">
				...
				<span class="gjszmdm">
					<a href="Information.sf" class="center_in_self"><span>信息资料</span></a>
					<a href="Bank_Card.sf" class="center_in_self"><span>银行卡管理</span></a>
					<a href="Delivery_address.sf" class="center_in_self"><span>收货地址管理</span></a>
				</span>
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img
			...
			<span class="gjszmdm"> <a href="Order.sf" class="center_in_self"><font>我的订单</font></a>
				...
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img src="<%=request.getContextPath()%>/static/User_Data_Update/images/wdssc.png" />
					<em>收藏管理</em> <b></b>
				</div>
				<span class="gjszmdm"> <a href="#" class="center_in_self"><span>店铺收藏</span></a>
					<a href="#" class="center_in_self"><span>菜品收藏</span></a>
				</span>
		...
		<div class="public_m1">
			...
			<div class="public_m4">
				...
				<form action="update_bankcard.sf" method="post">
					<div class="public_m4">
				<p>
					<em>银行名称：</em> <label>
					<select name="useryinhangming" style="height: 23px; border: 1px solid #eaeaea">
						<option>-请选择-</option>
				...
				<p>
					<em>户主姓名：</em> <label>
					<input name="huzhuxingming" type="text" style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</label>
				</p>
				<p>
					<em>银行卡号：</em> <label>
					<input name="useryinhangka" type="text" style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</label>
				</p>
				<p>
					<em>确认卡号：</em> <label>
					<input name="useryinhangkahao"  type="text" style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</label>
				</p>
				<p>
					<em>开户银行银行地点：</em> <label>
					<input name="kaihuhangdizhi" type="text" style="height: 23px; border: 1px solid #eaeaea; width: 140px;" value="此处还未写">
				</label>
				</p>
					<p>
						<span style="color: red">${requestScope.title}</span>
					</p>
