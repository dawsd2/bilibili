...
<div style="width: 100%;height: 40px;" >
	<div style="background-color:rgb(255,255,255,0.9);z-index: 2">
		<div style="margin-left: 90%;">
			...
			<button style="background-color: #B5B5B5" class="btn btn-primary ladda-button" data-style="expand-left" id="userxinxi">
...
<div class="all-comments" >
	...
	<div align="center"><button style="background-color: #8968CD;color: white" type="button" id="buttonhide">动态留言板</button>&nbsp;&nbsp;&nbsp;&nbsp;<button style="background-color: #8968CD;color: white" type="button" id="buttonhide2">静态留言板</button></div>
		...
		<ul id="slider" class="slider">
			<c:forEach items="${messagelist}" var="messagelist">
				<li>
					...
					<br>
					<p style="color: red;">留言者:<a href="" style="color: lightpink;text-decoration:none;">&nbsp;${messagelist.messageuserName}</a><span style="color: blue;">&nbsp;&nbsp;&nbsp;留言时间:${messagelist.messageTime}</span></p>
				</li>
			</c:forEach>
		</ul>
	</div>
