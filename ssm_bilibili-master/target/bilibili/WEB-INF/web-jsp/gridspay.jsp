...
<body style="margin-top: 50px;margin-left: 100px;background-color: #F0FFF0">
<div class="showall" align="center">
	<!--left -->
	<div class="showbot">
		<div id="showbox">
			<img src="<%=request.getContextPath()%>${requestScope.gridslist.girdsimg}" width="400" height="400" />
	...
	<div class="tb-property">
		<div class="tr-nobdr">
			<h3>${requestScope.gridslist.girdsName}</h3>
		</div>
		<div class="txt">
			<span class="nowprice">￥<a href="">${requestScope.gridslist.girdsjiage}</a></span>
		...
		<div class="gcIpt">
			...
			<span class="Hgt">库存（${requestScope.gridslist.girdskucun}）</span>
		</div>
	...
	<script type="text/javascript">
		$("#lijigoumai").click(function(){
			...
			if(user!="null"){
				var a="Confirmorder.sf?girdsID=${requestScope.gridslist.gridsID}&gridsName=${requestScope.gridslist.girdsName}&gridskucun=${requestScope.gridslist.girdskucun}&gridsjiage=${requestScope.gridslist.girdsjiage}&gridsimg=${requestScope.gridslist.girdsimg}"
				location.href =  a;
			}else{
				alert("请登录之后购买");
		...
		$("#gouwuce").click(function(){
			...
			if(user!="null"){
				var html = "";
				var girdsName="${requestScope.gridslist.girdsName}";//商品名字
				var girdsimg = "${requestScope.gridslist.girdsimg}";//商品图片地址
				var girdsjiage = "${requestScope.gridslist.girdsjiage}";//商品价格
				var girdsID = "${requestScope.gridslist.gridsID}";//商品ID
